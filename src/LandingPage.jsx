...
// ============================================================
// LOGO: Claude Mascot (Doctor)
// ============================================================
function Logo({ size = 80, className = '' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 12 10" fill="none" className={className} xmlns="http://www.w3.org/2000/svg">
      <g fill="#D97706">
      ...
      <rect x="3" y="2" width="1.5" height="1.5" fill="#2D2D3A" />
      <rect x="7.5" y="2" width="1.5" height="1.5" fill="#2D2D3A" />
      ...
      <circle cx="6" cy="1" r="0.5" fill="#2D2D3A" />
